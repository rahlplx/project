...
class Guardrails {
  ...
  check(action, _context = {}) {
    ...
    return {
      ...
      blocked,
      reason: blocked
        ? 'Action blocked by guardrail. Review confirmations.'
        : 'Action allowed with confirmations.',
      confirmations,
  ...
  _getGuardrails() {
    return [
      ...
      },
      {
        ...
        message:
          'This operates on a spec file. Confirm the spec is backed up and changes are intentional.',
      },
      {
        id: 'G10',
        autoBlock: false,
        ...
        message:
          'This affects acceptance criteria. Verify criteria still reflect stakeholder intent.',
      },
      {
        id: 'G11',
        autoBlock: true,
        ...
        message:
          'Decomposition changes task structure. This is auto-blocked; review the plan first.',
      },
      {
        id: 'G12',
        autoBlock: false,
  ...
  toJSON() {
    return {
      ...
      guardrails: this._getGuardrails().map(g => ({
        id: g.id,
        title: g.title,
        autoBlock: g.autoBlock,
      })),
