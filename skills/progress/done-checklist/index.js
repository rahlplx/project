      ...
      web: [
        {
          id: 'C01',
          category: 'security',
          check: 'Environment variables used (no hardcoded secrets)',
          severity: 'blocker',
        },
        {
          id: 'C02',
          category: 'security',
          check: 'Authentication implemented for protected routes',
          severity: 'blocker',
        },
        { id: 'C03', category: 'security', check: 'HTTPS enabled', severity: 'blocker' },
        {
          id: 'C04',
          category: 'quality',
          check: '404 page handles unknown routes gracefully',
          severity: 'high',
        },
        {
          id: 'C05',
          category: 'quality',
          check: 'Loading states shown during data fetch',
          severity: 'medium',
        },
        {
          id: 'C06',
          category: 'quality',
          check: 'Error states handled (network failure, empty data)',
          severity: 'high',
        },
        {
          id: 'C07',
        ...
        },
        {
          id: 'C08',
          category: 'design',
          check: 'Colors have sufficient contrast (WCAG AA)',
          severity: 'medium',
        },
        {
          id: 'C09',
          category: 'performance',
          check: 'Images optimized (lazy loading, proper sizes)',
          severity: 'low',
        },
        {
          id: 'C10',
        ...
        },
        {
          id: 'C12',
          category: 'deploy',
          check: 'Analytics configured (optional)',
          severity: 'low',
        },
        {
          id: 'C13',
          category: 'legal',
          check: 'Privacy policy and terms of service present',
          severity: 'high',
        },
        {
          id: 'C14',
          category: 'legal',
          check: 'GDPR/Cookie consent if applicable',
          severity: 'medium',
        },
        {
          id: 'C15',
          category: 'testing',
          check: 'Core user flow works end-to-end',
          severity: 'blocker',
        },
        {
          id: 'C16',
          category: 'testing',
          check: 'Edge cases handled (empty state, long text, special chars)',
          severity: 'medium',
        },
      ],
      api: [
        ...
        { id: 'A03', category: 'security', check: 'Rate limiting configured', severity: 'high' },
        {
          id: 'A04',
          category: 'quality',
          check: 'All endpoints return consistent JSON format',
          severity: 'high',
        },
        {
          id: 'A05',
          category: 'quality',
          check: 'Proper HTTP status codes used',
          severity: 'medium',
        },
        {
          id: 'A06',
        ...
        },
        {
          id: 'A07',
          category: 'docs',
          check: 'API documentation generated (OpenAPI/Swagger)',
          severity: 'high',
        },
        {
          id: 'A08',
      ...
      cli: [
        {
          id: 'CLI01',
          category: 'quality',
          check: 'Help/--help flag shows usage',
          severity: 'blocker',
        },
        {
          id: 'CLI02',
          category: 'quality',
          check: 'Clear error messages for invalid input',
          severity: 'high',
        },
        {
          id: 'CLI03',
          category: 'quality',
          check: 'Exit codes correctly set (0 for success, 1 for error)',
          severity: 'high',
        },
        {
          id: 'CLI04',
          category: 'deploy',
          check: 'Can be installed via npm global or npx',
          severity: 'high',
        },
        {
          id: 'CLI05',
          category: 'testing',
          check: 'Works on Windows, macOS, Linux',
          severity: 'medium',
        },
      ],
    };
