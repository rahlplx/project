...
const SKILL_KEYWORDS = ['deploy', 'test', 'plan', 'review', 'security', 'evolve', 'design', 'explain', 'status', 'tdd'];
...
function shouldInject(userMessage, skillName) {
  ...
  return SKILL_KEYWORDS.some(kw => msg.includes(kw));
}
...
module.exports = { setMode, getMode, setCaveman, isCavemanActive, shouldInject, menuStatus, VALID_MODES };
