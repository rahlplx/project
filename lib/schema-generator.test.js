...
describe('SchemaGenerator', () => {
  ...
  it('extracts multiple parameters with mixed defaults', () => {
    ...
    assert.deepStrictEqual(schema.properties.projectPath, {
      type: 'string',
      description: 'File or directory path',
      default: '.',
    });
    assert.deepStrictEqual(schema.properties.options, {
      type: 'object',
  ...
  it('extracts boolean parameter from default', () => {
    ...
    assert.deepStrictEqual(schema.properties.production, {
      type: 'boolean',
  ...
  it('extracts number parameter from default', () => {
    ...
    assert.deepStrictEqual(schema.properties.attempts, {
      type: 'number',
      description: 'Parameter value',
      default: 3,
    });
