...
describe('generatePrdMd', () => {
  test('generates PRD.md with all sections', () => {
    ...
    expect(result).toContain('- As a Restaurant owner, I want manage menu so that update offerings easily');
    expect(result).toContain('- As a Customer, I want place orders so that order food conveniently');
