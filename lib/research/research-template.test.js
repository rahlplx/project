...
describe('research template', () => {
  test('generates research doc with all sections', () => {
    const data = {
      ...
      competitors: [
        { name: 'Comp A', url: 'https://compA.com', strengths: ['Feature 1'], weaknesses: ['Limitation 1'] }
      ],
      openSourceTools: [
        { name: 'Tool A', repo: 'https://github.com/toolA', stars: 1000, license: 'MIT', description: 'Test tool' }
      ],
