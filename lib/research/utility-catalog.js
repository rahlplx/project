...
const UTILITY_CATALOG = {
  auth: {
    repos: [
      ...
      {
        name: 'Auth.js',
        url: 'https://github.com/authjs/authjs',
        stars: 5000,
        license: 'ISC',
      ...
      },
      {
        ...
        stars: 5000,
        license: 'MIT',
        description: 'Node.js SDK for Auth0',
      },
    ],
  },
  api: {
    repos: [
      ...
      },
      {
        ...
        stars: 30000,
        license: 'Apache-2.0',
        description: 'Blazingly fast, instant realtime GraphQL APIs',
      },
      {
        name: 'PostgREST',
    ...
    repos: [
      {
        ...
        stars: 37000,
        license: 'MIT',
        description: 'The Stripe Node.js library',
      },
      {
        name: 'Lemon Squeezy',
        ...
        stars: 500,
        license: 'MIT',
        description: 'Lemon Squeezy API client for JavaScript',
      },
      {
        name: 'Paddle',
        url: 'https://github.com/PaddleHQ/paddle-node',
        stars: 200,
        license: 'MIT',
        description: 'Paddle API client for Node.js',
      },
      {
        name: 'Chargebee',
        ...
        stars: 100,
        license: 'MIT',
        description: 'Chargebee API client for Node.js',
      },
      {
        name: 'Recurly',
        url: 'https://github.com/recurly/recurly-client-node',
        stars: 100,
        license: 'MIT',
        description: 'Recurly API client for Node.js',
      },
      {
        name: 'Billing.js',
        url: 'https://github.com/nicholasgasior/billing.js',
        stars: 50,
        license: 'MIT',
        description: 'Simple billing library',
      },
      {
        name: 'PayPal SDK',
        ...
        stars: 1000,
        license: 'Apache-2.0',
        description: 'PayPal SDK for Node.js',
      },
      {
        name: 'Square SDK',
        ...
        stars: 300,
        license: 'MIT',
        description: 'Square SDK for Node.js',
      },
      {
        name: 'Braintree',
        ...
        stars: 400,
        license: 'MIT',
        description: 'Braintree API client for Node.js',
      },
    ],
  },
  permissions: {
    repos: [
      {
        ...
        stars: 6000,
        license: 'MIT',
        description: 'Isomorphic authorization library for managing roles and permissions',
      },
      {
        name: 'AccessControl',
      ...
      {
        name: 'RBAC',
        url: 'https://github.com/otavio-sf/rbac',
        stars: 200,
        license: 'MIT',
        description: 'Role Based Access Control for Node.js',
      },
      {
        name: 'Node ACL',
        url: 'https://github.com/optimalboost/node-acl',
        stars: 2500,
        license: 'MIT',
        description: 'An ACL (access control list) implementation for Node.js',
      },
      {
        name: 'Casbin',
        ...
        stars: 2500,
        license: 'Apache-2.0',
        description: 'An authorization library that supports various access control models',
      },
      {
        name: 'Permify',
        ...
        stars: 3000,
        license: 'Apache-2.0',
        description: 'Open source authorization service',
      },
      {
        ...
        stars: 9000,
        license: 'Apache-2.0',
        description: 'Open Policy Agent (OPA) is a general-purpose policy engine',
      },
      {
        name: 'SpiceDB',
      ...
      },
      {
        ...
        stars: 1500,
        license: 'Apache-2.0',
        description: 'A general-purpose authorization library',
      },
    ],
  },
};
