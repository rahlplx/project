...
describe('gatherSkillFiles', () => {
  test('returns all 45 skill paths', () => {
  ...
  test('returns all unique skill directories', () => {
    ...
    expect(dirs).toEqual([
      ...
      'explain/code-translator',
      'explain/intent-capture',
      'knowledge/context-memory',
      'knowledge/graphify',
      'knowledge/knowledge-base',
      'knowledge/wednesday-graph',
      'orchestration/model-router',
      'orchestration/parallel-exec',
      'orchestration/task-coordinator',
      'orchestration/virtual-team',
      'preview/diff-preview',
      'preview/flowchart-gen',
      'preview/screenshot-preview',
      'preview/visual-plans',
      'progress/dashboard',
      'progress/done-checklist',
      'progress/error-translator',
      'progress/tracker',
      'quality/anti-patterns',
      'quality/code-review',
      'quality/guardrails',
      'quality/health-check',
      'quality/security-defaults',
