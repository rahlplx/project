...
describe('SubagentDispatch', () => {
  ...
  it('getCapabilities reports experimentalExecution and platform', () => {
    const caps = subagentDispatch.getCapabilities();
    assert.strictEqual(caps.experimentalExecution, true);
    assert.strictEqual(caps.platform, 'stub');
  });
});
