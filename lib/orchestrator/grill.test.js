...
describe('Grill', () => {
  ...
  it('should flag a vague request even if long enough', () => {
    assert.strictEqual(
      grill.needsGrilling('please make this website nicer for everyone visiting it'),
      true
    );
  });
  ...
  it('should not flag a specific, well-scoped request', () => {
    const request =
      'Add a "forgot password" link below the login form that emails a reset token to the user';
