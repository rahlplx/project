...
// Map skill names → prompt-template categories (adaptive selection)
const SKILL_TO_TEMPLATE = {
  'tdd-vibe': 'testing',
  'verification': 'testing',
  'done-verifier': 'testing',
  'security-audit': 'security',
  'security-defaults': 'security',
  'guardrails': 'security',
  'one-click-vercel': 'devops',
  'one-click-netlify': 'devops',
  'git-free-deploy': 'devops',
  'code-review': 'refactor',
  'anti-patterns': 'refactor',
  'code-health': 'refactor',
  'anti-slop': 'web',
  'design-system': 'web',
  'planning-agent': 'ai-agent',
  'parallel-exec': 'ai-agent',
  'virtual-team': 'ai-agent',
  'context-memory': 'ai-agent',
...
module.exports = { QueryEnricher, SOURCES, WEIGHTS, SKILL_TO_TEMPLATE };
