...
describe('error-trends', () => {
  ...
  it('appends errors', withIsolatedDir((dir) => {
  ...
  it('categorizes system errors (ENOENT)', withIsolatedDir((dir) => {
  ...
  it('getErrorTrends recentErrors is capped at 20', withIsolatedDir((dir) => {
    for (let i = 0; i < 25; i++) {
  ...
  it('getErrorSummary returns correct structure', withIsolatedDir((dir) => {
  ...
  it('getErrorSummary categories have percentages', withIsolatedDir((dir) => {
  ...
  it('getErrorSummary tracks firstRecorded and lastRecorded', withIsolatedDir((dir) => {
