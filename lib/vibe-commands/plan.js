...
const handler = (args, state) => {
  ...
  console.log('  Review the think output with the user from 3 perspectives:');
  console.log('  1. CEO: Does this solve a real problem? Is the scope right?');
  console.log('  2. Engineer: Is the approach technically sound? Any risks?');
  console.log('  3. Designer: Is the UX considered? Edge cases?');
