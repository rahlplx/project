...
const handler = (args, state) => {
  ...
  console.log('  1. CEO: Does this solve a real problem? Is the scope right? (StrategyEngine.ceoReview)');
  console.log('  2. Engineer: Is the approach technically sound? Any risks? (StrategyEngine.engineerReview)');
