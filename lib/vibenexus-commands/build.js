...
const handler = (args, state) => {
  ...
  console.log('\n  Usage: npx vibenexus build [task-name]');
  ...
  console.log('  After all tasks done, run: npx vibenexus harness');
  console.log(
    '  \x1b[2mRequires AI agent to dispatch subagents. Run in Codex/OpenCode for TDD loop.\x1b[0m\n'
  );
